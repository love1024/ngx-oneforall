![Bundle Size](https://deno.bundlejs.com/badge?q=ngx-oneforall/services/cache&treeshake=[*]&config={"esbuild":{"external":["rxjs","@angular/core","@angular/common","@angular/forms","@angular/router"]}})
