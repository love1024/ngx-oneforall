![Bundle Size](https://deno.bundlejs.com/badge?q=ngx-oneforall/directives/press-enter&treeshake=[*]&config={"esbuild":{"external":["rxjs","@angular/core","@angular/common","@angular/forms","@angular/router"]}})
