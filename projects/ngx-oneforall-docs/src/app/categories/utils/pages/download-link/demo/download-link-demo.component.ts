...
@Component({
    ...
    template: `
        <div class="demo-container">
            <h3>Download Demo</h3>
            <p>Click the button below to download a dynamically generated text file.</p>
...
export class DownloadLinkDemoComponent {
    downloadTextFile() {
        const text = 'Hello, this is a sample text file downloaded using downloadLink utility!';
