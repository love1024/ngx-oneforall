...
export class LiveSearchDemoComponent {
    ...
    private mockData: SearchResult[] = [
        { id: 1, title: 'Angular', description: 'A platform for building web applications' },
        { id: 2, title: 'React', description: 'A JavaScript library for building user interfaces' },
        { id: 3, title: 'Vue', description: 'The Progressive JavaScript Framework' },
        { id: 4, title: 'TypeScript', description: 'JavaScript with syntax for types' },
        { id: 5, title: 'RxJS', description: 'Reactive Extensions for JavaScript' },
        { id: 6, title: 'NgRx', description: 'Reactive State for Angular' },
        { id: 7, title: 'Angular Material', description: 'Material Design components for Angular' },
        { id: 8, title: 'Tailwind CSS', description: 'A utility-first CSS framework' },
    ];
