...
import { minDate, MinDateDirective } from '@ngx-oneforall/validators';
...
@Component({
    ...
    template: `
        ...
        <div class="demo-container">
            ...
            <label>
                Enter Date:
                <input type="date" [(ngModel)]="templateValue" [minDate]="minDateValue" #templateCtrl="ngModel">
            </label>
