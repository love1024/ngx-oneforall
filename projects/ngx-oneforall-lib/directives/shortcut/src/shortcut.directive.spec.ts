...
describe('ShortcutDirective', () => {
  ...
  it('should create an instance', () => {
    const directive = fixture.debugElement.query(
      By.directive(ShortcutDirective)
    );
  ...
  describe('Element-scoped shortcuts (default)', () => {
    ...
    it('should NOT trigger when event path does not include element', () => {
      ...
      jest
        ...
        .mockReturnValue([document.body, document.documentElement, window]);
  ...
  describe('Key tracking and cleanup', () => {
    ...
    it('should track and remove keys on keyup (global mode)', () => {
      ...
      const sDownEvent = new KeyboardEvent('keydown', {
        key: 's',
        ctrlKey: true,
        shiftKey: true,
      });
      ...
      // Release S
      const sUpEvent = new KeyboardEvent('keyup', {
        key: 's',
        ctrlKey: true,
        shiftKey: true,
      });
      ...
      const sDownEvent2 = new KeyboardEvent('keydown', {
        key: 's',
        ctrlKey: true,
        shiftKey: true,
      });
