...
describe('liveSearch', () => {
    it('should debounce input values', fakeAsync(() => {
        ...
        source.pipe(liveSearch(300, dataProducer)).subscribe(result => results.push(result));
    ...
    it('should  switch to new observables and cancel previous ones', fakeAsync(() => {
        ...
        source.pipe(liveSearch(100, dataProducer)).subscribe(result => results.push(result));
    ...
    it('should respect custom delay values', fakeAsync(() => {
        ...
        source.pipe(liveSearch(500, dataProducer)).subscribe(result => results.push(result));
    ...
    it('should handle async data producer responses', fakeAsync(() => {
        ...
        source.pipe(liveSearch(200, dataProducer)).subscribe(result => results.push(result));
